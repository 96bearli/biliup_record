...
async def download(url: str):
    ...
    try:
        ...
        # print(e)
        print(f"* Error:Download_failed:{url},check file'{paths[1] + 'Img_failed.txt'}")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 1:
        ...
        if len(sys.argv) == 3:
            ...
            img = False
        print(f"* 已获取参数参数 <目标UID：{uids},下载图片：{img}>")
    else:
        print(f"* 使用内置参数 <目标UID：{uids},下载图片：{img}>")
